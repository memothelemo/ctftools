// Copied from: https://github.com/rust-lang/cargo/blob/973538787ee13a52199c07ba9b14135e4cac19e7/crates/cargo-util/src/process_error.rs
// Licensed under MIT/Apache-2.0
use std::fmt;
use std::process::{ExitStatus, Output};
use std::str;

/// Error value for [`ProcessBuilder`] when a process fails.
#[derive(Debug)]
...
pub fn exit_status_to_string(status: ExitStatus) -> String {
    ...
    #[cfg(windows)]
    fn status_to_string(status: ExitStatus) -> String {
        use windows::Win32::Foundation::{self as codes, NTSTATUS};

        let mut base = status.to_string();
        let extra = match NTSTATUS(status.code().unwrap() as i32) {
            codes::STATUS_ACCESS_VIOLATION => "STATUS_ACCESS_VIOLATION",
            codes::STATUS_IN_PAGE_ERROR => "STATUS_IN_PAGE_ERROR",
            codes::STATUS_INVALID_HANDLE => "STATUS_INVALID_HANDLE",
            codes::STATUS_INVALID_PARAMETER => "STATUS_INVALID_PARAMETER",
            codes::STATUS_NO_MEMORY => "STATUS_NO_MEMORY",
            codes::STATUS_ILLEGAL_INSTRUCTION => "STATUS_ILLEGAL_INSTRUCTION",
            codes::STATUS_NONCONTINUABLE_EXCEPTION => "STATUS_NONCONTINUABLE_EXCEPTION",
            codes::STATUS_INVALID_DISPOSITION => "STATUS_INVALID_DISPOSITION",
            codes::STATUS_ARRAY_BOUNDS_EXCEEDED => "STATUS_ARRAY_BOUNDS_EXCEEDED",
            codes::STATUS_FLOAT_DENORMAL_OPERAND => "STATUS_FLOAT_DENORMAL_OPERAND",
            codes::STATUS_FLOAT_DIVIDE_BY_ZERO => "STATUS_FLOAT_DIVIDE_BY_ZERO",
            codes::STATUS_FLOAT_INEXACT_RESULT => "STATUS_FLOAT_INEXACT_RESULT",
            codes::STATUS_FLOAT_INVALID_OPERATION => "STATUS_FLOAT_INVALID_OPERATION",
            codes::STATUS_FLOAT_OVERFLOW => "STATUS_FLOAT_OVERFLOW",
            codes::STATUS_FLOAT_STACK_CHECK => "STATUS_FLOAT_STACK_CHECK",
            codes::STATUS_FLOAT_UNDERFLOW => "STATUS_FLOAT_UNDERFLOW",
            codes::STATUS_INTEGER_DIVIDE_BY_ZERO => "STATUS_INTEGER_DIVIDE_BY_ZERO",
            codes::STATUS_INTEGER_OVERFLOW => "STATUS_INTEGER_OVERFLOW",
            codes::STATUS_PRIVILEGED_INSTRUCTION => "STATUS_PRIVILEGED_INSTRUCTION",
            codes::STATUS_STACK_OVERFLOW => "STATUS_STACK_OVERFLOW",
            codes::STATUS_DLL_NOT_FOUND => "STATUS_DLL_NOT_FOUND",
            codes::STATUS_ORDINAL_NOT_FOUND => "STATUS_ORDINAL_NOT_FOUND",
            codes::STATUS_ENTRYPOINT_NOT_FOUND => "STATUS_ENTRYPOINT_NOT_FOUND",
            codes::STATUS_CONTROL_C_EXIT => "STATUS_CONTROL_C_EXIT",
            codes::STATUS_DLL_INIT_FAILED => "STATUS_DLL_INIT_FAILED",
            codes::STATUS_FLOAT_MULTIPLE_FAULTS => "STATUS_FLOAT_MULTIPLE_FAULTS",
            codes::STATUS_FLOAT_MULTIPLE_TRAPS => "STATUS_FLOAT_MULTIPLE_TRAPS",
            codes::STATUS_REG_NAT_CONSUMPTION => "STATUS_REG_NAT_CONSUMPTION",
            codes::STATUS_HEAP_CORRUPTION => "STATUS_HEAP_CORRUPTION",
            codes::STATUS_STACK_BUFFER_OVERRUN => "STATUS_STACK_BUFFER_OVERRUN",
            codes::STATUS_ASSERTION_FAILURE => "STATUS_ASSERTION_FAILURE",
            _ => return base,
        };
        base.push_str(", ");
        base.push_str(extra);
